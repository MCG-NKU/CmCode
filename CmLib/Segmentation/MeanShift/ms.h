...
// Threshold
const double	EPSILON_E		= 0.01;			// define threshold (approx. Value of Mh at a peak or plateau)
...
const int		GAUSS_NU_ELS   = 16;		// take 16 samples of exp(-u/2)
const double	GAUSS_LIMIT     = 2.9;		// GAUSS_LIMIT     = c
const double	GAUSS_INCREMENT = GAUSS_LIMIT*GAUSS_LIMIT/GAUSS_NU_ELS;
