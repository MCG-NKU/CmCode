...
public:
 ...
 /*\/\/\/\/\/\/\/\/\/\/*/
  ...
  int GetLabels(int **labels_out);

  //get the private value labels of msImageProcessor
  int MyGetRegions(int*);
...
int MeanShiftEdison(CMat &img3b, Mat &idx1i, int sigmaS = 7, float sigmaR = 10, int minReg = 20);        
